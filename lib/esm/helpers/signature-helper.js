...
exports.getSignatureKeyHeader = exports.validateSignatureHeader = exports.validateSignatureKey = exports.generateSignatureKey = exports.generateSignatureInput = exports.generateSignature = void 0;
...
const getSignatureKeyHeader = (config) => config.signatureKeyHeader;
exports.getSignatureKeyHeader = getSignatureKeyHeader;
/**
...
async function validateSignatureHeader(headers, config) {
    ...
    const signatureKey = headers[signatureKeyHeader];
    if (!signatureKey) {
    ...
    if (config.publicKey) {
        const expectedPublicKey = (0, common_1.sanitizeKey)((0, common_1.readKey)(config.publicKey));
        const sanitizedPublicKey = (0, common_1.sanitizeKey)(publicKey);
